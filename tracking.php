                  ...
                  <iframe class="map" src="https://maps.google.com/maps?q=Mount%20Pleasant,%20Breach%20Lane,%20Sittingbourne,%20ME9%207DB&amp;t=k&amp;z=13&amp;ie=UTF8&amp;iwloc=&amp;output=embed" style="border:0; width: 100%; height: 527px;"></iframe>
                    ...
                    <div class="col-md-12 mt-5">
                        ...
                        <div class="timeline">
                            ...
                            if ($hasCustomDate) {
                                $history_query = mysqli_query($link, "SELECT tracking_number, status, location, remarks, custom_date, created_at FROM shipment_history WHERE tracking_number = '$tracking_num' ORDER BY COALESCE(custom_date, created_at) DESC");
                            } else {
                                $history_query = mysqli_query($link, "SELECT tracking_number, status, location, remarks, created_at FROM shipment_history WHERE tracking_number = '$tracking_num' ORDER BY created_at DESC");
                            }
          ...
          <div class="col-sm-6 col-lg-3 order-lg-1 mb-5 mb-lg-0">
            ...
            <ul class="footer-contact list-unstyled">
              ...
              <li>
                ...
                <div class="footer-contact-info" >
                 <a href="https://wa.me/+1 (Phone Number)"><style="image src: url(images/whatsap.png)"
                  <span>+ (Phone Number)
</span></a>
