...
## Overview
This document outlines the major enhancements made to the Hybreed Courier shipment tracking system.
...
- Company branding with Hybreed Courier colors
...
mysql -u royalcargodbtt -p royalcargodbtt < database.sql
```
...
4. **Email Templates**: Admin panel to customize email templates
