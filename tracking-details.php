...
<!--            <p class="inner-subtitle text-white">For those of you who are serious about having more, doing more, giving more and being more, success is achievable. Yes for more we do it through shipping, fastest shipping network accross the globe fast and safe</p>-->
  ...
  <section class="feature-area section-gap" style="margin-bottom: 120px">
         ...
         ?>
                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <table class="table table-hover" id="dev-table">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><b>Address:</b></td>
                                                <td> <?php echo htmlspecialchars($data['receiver_address']) ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                        ...
                        <table class="table table-striped table-bordered table-condensed">
                            ...
                            <tbody>
                               ...
                               <!--  <tr>
                                    ...
                                    <td class="col-xs-6">  &nbsp; <IMG SRC="images/loading.gif" height="20" width="42">&nbsp; </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="text-right"><b>Current Location  <IMG SRC="images/loading.gif" style="height: 30px; width: 50px"> </b></td>
             ...
             <table class="table table-striped table-bordered table-condensed">
                <tbody>
                  <iframe class="map" src="https://maps.google.com/maps?q=<?php echo urlencode($data['current_location'] == "" ? $data['dispatch_location'] : $data['current_location']) ?>&amp;t=k&amp;z=13&amp;ie=UTF8&amp;iwloc=&amp;output=embed" style="border:0; width: 100%; height: 527px;"></iframe>
                </tbody>
             </table>
                    <!-- <div class="row">
                    ...
                    <div class="col-md-12 mt-5">
                        ...
                        <div class="timeline">
                            ...
                            mysqli_stmt_bind_param($history_stmt, "s", $tracking_num);
                            ...
                            if (mysqli_num_rows($history_query) > 0) {
                                ...
                                while ($history = mysqli_fetch_assoc($history_query)) {
                                    ...
                                    $first = false;
                                    // Use custom_date if available, otherwise fall back to created_at
                                    $display_date = ($hasCustomDate && !empty($history['custom_date'])) ? $history['custom_date'] : $history['created_at'];
                            ?>
