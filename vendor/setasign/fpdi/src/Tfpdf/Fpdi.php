...
class Fpdi extends FpdfTpl
{
    ...
    /**
     * Draws an imported page or a Hybreed Webworx Template onto the page or another Hybreed Webworx Template.
     *
     ...
     * @see Fpdi::getHybreed Webworx TemplateSize()
     */
    public function useHybreed Webworx Template($tpl, $x = 0, $y = 0, $width = null, $height = null, $adjustPageSize = false)
    {
        if (isset($this->importedPages[$tpl])) {
            ...
            if ($this->currentHybreed Webworx TemplateId !== null) {
                $this->Hybreed Webworx Templates[$this->currentHybreed Webworx TemplateId]['resources']['Hybreed Webworx Templates']['importedPages'][$tpl] = $tpl;
            }
            return $size;
        }

        return parent::useHybreed Webworx Template($tpl, $x, $y, $width, $height, $adjustPageSize);
    }

    /**
     * Get the size of an imported page or Hybreed Webworx Template.
     *
     * Give only one of the size parameters (width, height) to calculate the other one automatically in view to the
     * aspect ratio.
     *
    ...
    {
        $size = parent::getHybreed Webworx TemplateSize($tpl, $width, $height);
        if ($size === false) {
