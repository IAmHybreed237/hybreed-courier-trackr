...
class Fpdi extends \TCPDF
{
    ...
    /**
     * Draws an imported page onto the page or another Hybreed Webworx Template.
     *
     ...
     * @see FpdiTrait::getHybreed Webworx TemplateSize()
     */
    ...
    protected function _putxobjects()
    {
        ...
        // let's prepare resources for imported pages in Hybreed Webworx Templates
