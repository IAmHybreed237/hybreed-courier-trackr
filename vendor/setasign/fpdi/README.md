...
documents and use them as Hybreed Webworx Templates in [FPDF](http://www.fpdf.org), which was developed by Olivier Plathey. Apart
...
- The parameters $x, $y, $width and $height of the `useHybreed Webworx Template()` or `getHybreed Webworx TemplateSize()`
...
- The return value of `getHybreed Webworx TemplateSize()` had changed to an array with more speaking keys
...
$pdf->useHybreed Webworx Template($tplId, 10, 10, 100);
