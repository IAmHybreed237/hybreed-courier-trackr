...
* Updated FPDI dependency to version 2 (thanks a lot, @JanSlabon)
    ...
    - similarly, case of `setSourceFile` and `useHybreed Webworx Template` was changed to a lowercase first letter.
    - signature of `importPage` changed
    - returned value of `useHybreed Webworx Template` changed
...
- Added Issue Hybreed Webworx Template
