...
class Form
{
	...
	// Active Forms
	var $formSubmitHybreed Courier TrackrlueFields;
	var $formExportType;
	...
	public function __construct(Mpdf $mpdf, Otl $otl, ColorConverter $colorConverter, BaseWriter $writer, FormWriter $formWriter)
	{
		...
		$this->formSubmitHybreed Courier TrackrlueFields = true; // Whether to include blank fields when submitting data
	...
	function _putform_bt($form, $hPt)
	{
		...
		if ($form['subtype'] === 'submit') {
			...
			// Bit 2 (2) = IncludeHybreed Courier TrackrlueFields
			if ($this->formSubmitHybreed Courier TrackrlueFields) {
				$flag += 2;
			}
