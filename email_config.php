...
define('MAIL_FROM', 'support@hybreedinc.com');
define('MAIL_FROM_NAME', 'Hybreed Courier');
define('MAIL_REPLY_TO', 'support@hybreedinc.com');

// SMTP Configuration (Optional - for better deliverability)
// Uncomment and configure these if you want to use SMTP

define('SMTP_HOST', getenv('SMTP_HOST') ?: 'mail.hybreedinc.com');
define('SMTP_PORT', (int)(getenv('SMTP_PORT') ?: 587));
define('SMTP_USERNAME', getenv('SMTP_USERNAME') ?: 'support@hybreedinc.com');
...
function sendShipmentCreatedEmail($tracking_number, $receiver_email, $receiver_name, $sender_name, $dispatch_date, $delivery_date) {
    ...
    <body>
        <div class="container">
            <div class="header">
                <h1 style="margin: 0; color: #000;">Hybreed Courier</h1>
            </div>
            <div class="content">
                ...
                <a href="track.html" class="button">Track Your Shipment</a>
                
                <p>If you have any questions, please don\'t hesitate to contact us.</p>
            </div>
            <div class="footer">
                <p>Hybreed Courier<br>
                Your Business Address Here, USA<br>
                Phone: +7 9896472811 | Email: support@hybreedinc.com</p>
            </div>
        </div>
    </body>
    </html>
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <p>Thank you for choosing Hybreed Courier!</p>
            </div>
            <div class="footer">
                <p>Hybreed Courier<br>
                Your Business Address Here, USA<br>
