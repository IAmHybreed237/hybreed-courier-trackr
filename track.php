...
<head>
    ...
    <meta name="description" content="Hybreed Courier Trackr - We Deal With your Logistics & Shipping Needs!">
...
<meta property="twitter:image" content="https://rapidexpressagency.com/images/banner_1.png"/>
    ...
    <title>Tracking Details - Hybreed Courier Trackr</title>
...
<!--                      <li><a class="dropdown-item" href="service-detail.php"><span>Service detail</span></a></li>-->
                  ...
                  <li class="nav-item dropdown">
                    <a class="nav-link" href="track-your-shipment.html" >Track your Shipment<i class=""></i></a>
                  ...
                  <iframe class="map" src="https://maps.google.com/maps?q=<?php echo $data['current_location'] == "" ? $data['dispatch_location'] : $data['current_location'] ?>&amp;t=k&amp;z=13&amp;ie=UTF8&amp;iwloc=&amp;output=embed" style="border:0; width: 100%; height: 527px;"></iframe>
                    ...
                    <div class="col-md-12 mt-5">
                        ...
                        <div class="timeline">
                            ...
                            if ($hasCustomDate) {
                                $history_query = mysqli_query($link, "SELECT tracking_number, status, location, remarks, custom_date, created_at FROM shipment_history WHERE tracking_number = '$tnumber' ORDER BY COALESCE(custom_date, created_at) DESC");
                            } else {
                                $history_query = mysqli_query($link, "SELECT tracking_number, status, location, remarks, created_at FROM shipment_history WHERE tracking_number = '$tnumber' ORDER BY created_at DESC");
                            }
            ...
            <ul class="footer-contact list-unstyled">
              <li>
                ...
                <div class="footer-contact-info">
                  <span>9747 Biederman Way Escalon California 95320,</span>
              ...
              <li>
                ...
                <div class="footer-contact-info" >
                 <a href="https://wa.me/447883241596"><style="image src: url(images/whatsap.png)"
                  <span>+1 (Phone Number)
</span></a>
              ...
              <li>
                ...
                <div class="footer-contact-info">
                  <span>track@HybreedCourierTrackr.com</span>
        ...
        <div class="copyright">
          <div class="row d-flex align-items-center">
            ...
            <div class="col-md-6 text-left text-md-right mt-4 mt-md-0">
              <p class="mb-0 text-white">©️ 2026 Hybreed Courier Trackr All rights reserved.</p>
            </div>
          </div>
        </div>
      </div>
