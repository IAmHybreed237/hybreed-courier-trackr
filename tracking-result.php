...
<head>
    ...
    <meta name="description" content="Hybreed Courier - We Deal With your Logistics & Shipping Needs!">
<meta property="og:image" content="images/banner_1.png"/>
<meta property="twitter:image" content="images/banner_1.png"/>
    <meta name="author" content="Hybreed X" />
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>Tracking Details - Hybreed Courier</title>
    ...
    <!-- Hybreed Webworx Template Style -->
...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>-->
      ...
      <div class="header-top" style="background-color:#052c52
        ...
        <div class="container">
          <nav class="navbar navbar-static-top navbar-expand-lg" style="text-decoration-color: darkblue!important">
            ...
            <a class="navbar-brand" href="/">
              <img class="img-fluid" src="logo/logo-placeholder.svg" alt="logo">
            </a>
...
-->
                  ...
                  <li class="dropdown nav-item" style="text-decoration-color: darkblue">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                      <li><a class="dropdown-item" href="service.html"><span>Service list</span></a></li>
                      <li><a class="dropdown-item" href="service-air-freight.html"><span>Air Freight</span></a></li>
                      <li><a class="dropdown-item" href="service-ocean-freight.html"><span>Ocean Freight</span></a></li>
                      <li><a class="dropdown-item" href="service-export-import.html"><span>Export & Import</span></a></li>
                      <li><a class="dropdown-item" href="service-road-freight.html"><span>Road Freight</span></a></li>
                   
                      <li><a class="dropdown-item" href="service-forwarding.html"><span>Logistics</span></a></li>
<!--                      <li><a class="dropdown-item" href="service-detail.php"><span>Service detail</span></a></li>-->
                    </ul>
                  </li>
                  <li class="nav-item dropdown">
                    <a class="nav-link" href="track.html" >Track your Shipment<i class=""></i></a>
...
-->
              ...
              <a class="btn btn-sm btn-outline-white d-none d-lg-block" href="contact.html">Get a quote</a>
            </div>
          </nav>
        </div>
      </div>
         ...
         ?>
                <div class="row">
                    ...
                    <div class="col-md-12 col-md-offset-0">
                        ...
                        <tbody>
                            <tr>
                                    <td class="text-center"><b>Parcel Description </b></td>
                                    <td> <?php echo $data['pdesc'] ?></td>
                                </tr>
                            <tr>
                                <td class="text-center"><b>Dispatch Location </b></td>
                            ...
                            <tr>
                                ...
                                ?>
                                <td class="text-center"><b>Current Location  <img src="images/loading.gif" style="height: 30px; width: 50px"> </b></td>
             ...
             <table class="table table-striped table-bordered table-condensed">
                <tbody>
                  <iframe class="map" src="https://maps.google.com/maps?q=<?php echo $data['current_location'] == "" ? $data['dispatch_location'] : $data['current_location'] ?>&amp;t=k&amp;z=13&amp;ie=UTF8&amp;iwloc=&amp;output=embed" style="border:0; width: 100%; height: 527px;"></iframe>
                    ...
                    <div class="col-md-12 mt-5">
                        <div class="panel-heading bg-warning p-2 mb-3">
                            <h4 class="panel-title">Shipment Journey / Timeline</h4>
                        </div>
                        ...
                        <div class="timeline">
                            ...
                            // Detect if custom_date column exists for robust ordering/display
                            ...
                            if ($hasCustomDate) {
                                $history_stmt = mysqli_prepare($link, "SELECT tracking_number, status, location, remarks, custom_date, created_at FROM shipment_history WHERE tracking_number = ? ORDER BY COALESCE(custom_date, created_at) DESC");
                            } else {
                                $history_stmt = mysqli_prepare($link, "SELECT tracking_number, status, location, remarks, created_at FROM shipment_history WHERE tracking_number = ? ORDER BY created_at DESC");
                            }
                            mysqli_stmt_bind_param($history_stmt, "s", $tnumber);
                            mysqli_stmt_execute($history_stmt);
                            $history_query = mysqli_stmt_get_result($history_stmt);
                            ...
                            ?>
                                <div class="timeline-item">
                                    <div class="timeline-marker <?php echo $is_active; ?>"></div>
                                    <div class="timeline-content <?php echo $is_active; ?>">
                                        ...
                                        <div class="timeline-date">
                                            <?php $display_date = ($hasCustomDate && !empty($history['custom_date'])) ? $history['custom_date'] : $history['created_at']; ?>
                                            <i class="far fa-clock"></i> <?php echo date('F d, Y h:i A', strtotime($display_date)); ?>
                                        </div>
                                        <?php if (!empty($history['remarks'])): ?>
                                            <div class="timeline-remarks"><?php echo htmlspecialchars($history['remarks']); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            <?php
                                ...
                                echo '<p class="text-center">No shipment history available yet.</p>';
                            }
                            ?>
                        </div>
                    </div>
                ...
                <center>
                    <a href="receipt.php?tnum=<?php echo $data['tracking_number'] ?>&action=view" class="btn btn-outline-primary" target="_blank">View Receipt</a>
                    <a href="receipt.php?tnum=<?php echo $data['tracking_number'] ?>&action=download" class="btn btn-primary">Download Receipt</a>
                </center>
          ...
          <div class="col-sm-6 col-lg-3 order-lg-1 mb-5 mb-lg-0">
            ...
            <ul class="footer-contact list-unstyled">
              ...
              <li>
                ...
                <div class="footer-contact-info" >
                 <a href="https://wa.me/79896472811">
                  <span>+7 9896472811
</span></a>
              ...
              <li>
                ...
                <div class="footer-contact-info">
                  <span>support@hybreedinc.com</span>
              ...
              <div class="row">
                <div class="col-md-6 col-xl-4">
                  ...
                  <ul class="list-unstyled mb-0">
                    ...
                    <li><a href="track.html">Track Your Shipment</a></li>
        ...
        <div class="copyright">
          <div class="row d-flex align-items-center">
            ...
            <div class="col-md-6 text-left text-md-right mt-4 mt-md-0">
              <p class="mb-0 text-white">©️ 2026 Hybreed Courier All rights reserved.</p>
            </div>
          </div>
        </div>
      </div>
...
<!--</div>-->
    ...
    <!-- Hybreed Webworx Template Scripts (Do not remove)-->
    <script src="js/custom.js"></script>
  <script>
  (function(){
    var d = <?php echo (isset($data) && !empty($data['delivery_date']) && strtotime($data['delivery_date'])) ? '"'.date('l, F j, Y', strtotime($data['delivery_date'])).'"' : '""'; ?>;
    if(!d){ return; }
    function speak(){
      if(!('speechSynthesis' in window)) return;
      if(document.visibilityState !== 'visible' || !document.hasFocus()) return;
      var u = new SpeechSynthesisUtterance("Your Shipment is scheduled for delivery on " + d);
      var v = speechSynthesis.getVoices();
      if(v && v.length){
        for(var i=0;i<v.length;i++){ if(/en/i.test(v[i].lang)){ u.voice = v[i]; break; } }
      }
      try{ speechSynthesis.cancel(); }catch(e){}
      speechSynthesis.speak(u);
    }
    var initial=8, interval=180, elapsed=0, first=false;
    function tick(){
      if(document.visibilityState==='visible' && document.hasFocus()){
        elapsed++;
        if(!first && elapsed>=initial){ speak(); first=true; elapsed=0; }
        else if(first && elapsed>=interval){ speak(); elapsed=0; }
      }
    }
    var timer = setInterval(tick,1000);
    document.addEventListener('visibilitychange', function(){ if(document.visibilityState!=='visible'){ try{ speechSynthesis.cancel(); }catch(e){} } });
    window.addEventListener('blur', function(){ try{ speechSynthesis.cancel(); }catch(e){} });
  })();
  </script>
  </body>
