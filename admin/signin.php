...
$username = $password= "";
    ...
    if (isset($_POST['submit'])) {
        ...
        if($username == "" || $password == ""){
            ...
            $stmt = mysqli_prepare($link, "SELECT id, username, password FROM admin WHERE username = ? AND password = ?");
...
<head>
  ...
  <title>Hybreed Courier - Admin Sign In</title>
  <!-- base:css -->
...
<body>
            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                <div class="brand-logo">
                  <img src="logo/logo-placeholder.svg" alt="logo">
                </div>
  ...
  <!-- endinject -->
  <!-- inject:js -->
  <script src="js/Hybreed Webworx Template.js"></script>
  <!-- endinject -->
</body>
